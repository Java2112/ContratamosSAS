...
<template>
    <CompanyLayout title="Crear Vacante">
        <template #header>
        ...
        <div class="py-12">
            <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
                <form @submit.prevent="submit" class="bg-white dark:bg-gray-800 p-8 shadow sm:rounded-lg">
                    ...
                    <!-- INFORMACIÓN GENERAL -->
                    <h3 class="text-lg font-bold border-b pb-2 mb-4">Información General</h3>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        ...
                        <div>
                            ...
                            <select id="employer_type" v-model="form.employer_type" class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 rounded-md shadow-sm">
                    ...
                    <h3 class="text-lg font-bold border-b pb-2 mb-4 mt-8">Condiciones Laborales</h3>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        <div>
                            <InputLabel value="Tipo de contrato" />
                            <select v-model="form.contract_type" class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 rounded-md">
                        ...
                        <div>
                            ...
                            <select v-model="form.payroll_frequency" class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 rounded-md">
                        ...
                        <div>
                            ...
                            <select v-model="form.workday_type" class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 rounded-md">
                    ...
                    <!-- SALARIO -->
                    <h3 class="text-lg font-bold border-b pb-2 mb-4 mt-8">Salario</h3>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        <div>
                            <InputLabel value="Oferta salarial" />
                            <select v-model="form.salary_type" class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 rounded-md">
                        ...
                        <div class="col-span-full">
                            <label class="flex items-center">
                                ...
                                <span class="ml-2 text-sm">¿Bonos o comisiones adicionales?</span>
                            </label>
                    ...
                    <h3 class="text-lg font-bold border-b pb-2 mb-4 mt-8">Modalidad y Ubicación</h3>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        <div>
                            <InputLabel value="Modalidad de trabajo" />
                            <select v-model="form.work_modality" class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 rounded-md">
                    ...
                    <h3 class="text-lg font-bold border-b pb-2 mb-4 mt-8">Requisitos del Candidato</h3>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        <div>
                            <InputLabel value="Nivel educativo mínimo" />
                            <select v-model="form.min_education_level" class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 rounded-md">
                    ...
                    <h3 class="text-lg font-bold border-b pb-2 mb-4 mt-8">Descripción del Cargo</h3>
                    <div class="mb-6 space-y-4">
                        <div>
                            <InputLabel for="main_functions" value="Funciones principales" />
                            <textarea id="main_functions" v-model="form.main_functions" rows="4" class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 rounded-md dark:placeholder-gray-500"></textarea>
                        </div>
                        <div>
                            <InputLabel for="optional_features" value="Otras características opcionales" />
                            <textarea id="optional_features" v-model="form.optional_features" rows="2" class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 rounded-md dark:placeholder-gray-500"></textarea>
                        </div>
                    </div>

                    <!-- TRATAMIENTO DE DATOS -->
                    <div class="mt-10 bg-gray-50 dark:bg-gray-900 p-4 rounded-lg text-sm border">
                        <label class="flex items-start">
                            <input type="checkbox" v-model="form.data_treatment_accepted" class="mt-1 rounded border-gray-300 text-blue-600 shadow-sm focus:ring-blue-500" required />
                            <span class="ml-3 text-gray-600 dark:text-gray-400">
                                <strong>Tratamiento de Datos:</strong> De conformidad con la Ley 1581 de 2012, Contratamos informa que los datos personales suministrados serán tratados únicamente para fines relacionados con procesos de reclutamiento y selección. Usted podrá ejercer sus derechos de acceso, corrección o supresión escribiendo a seleccion@contratamos.com.co
                            </span>
                        </label>
                    </div>
